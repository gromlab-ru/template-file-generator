...
2. `npm test` — генерация по примеру из корневого скилла, переменные, конфликты, API, автодополнение, ссылки скилла и правила релиза.
3. `npm run check:package` — упаковка, установка tarball во временный проект и проверка установленного CLI, API и наличия файлов скилла.
...
2. Поднимите версию и lock-файл, например командой `npm version patch --no-git-tag-version`.
